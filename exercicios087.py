while True:
    ...
    print('='*45)
    print(f'a soma dos valores pares e: {P}')
    print(f'a soma dos numeros da 3ª coluna e: {coluna3[0]+coluna3[1]+coluna3[2]}')
    print(f'o maior valor da 2ª coluna e: {maior[2]}')
